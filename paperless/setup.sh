...
echo ">> Target folder: $TARGET_FOLDER"
wget use_proxy=yes -e http_proxy=$http_proxy -e https_proxy=$http_proxy "https://raw.githubusercontent.com/paperless-ngx/paperless-ngx/main/docker/compose/docker-compose.$DOCKER_COMPOSE_VERSION.yml" -O docker-compose.yml
wget use_proxy=yes -e http_proxy=$http_proxy -e https_proxy=$http_proxy "https://raw.githubusercontent.com/paperless-ngx/paperless-ngx/main/docker/compose/.env" -O .env
